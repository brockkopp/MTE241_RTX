...
LNKFLGS= -o
TITLE=RTX.out
OBJ= debug.o initialize.o iprocesses.o RTX.o SignalHandler.o Scheduler.o CCI.o MsgEnv.o MsgServ.o MsgTrace.o WallClock.o Queue.o PQ.o PCB.o userProcesses.o tests.o tools.o
KB=KB.out
